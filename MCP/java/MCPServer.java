...
// Import Post_Wkhtmltopdf_HtmlMCPTool - included in same package
// Import Get_Wkhtmltopdf_UrlMCPTool - included in same package
// Import Post_Wkhtmltopdf_UrlMCPTool - included in same package
// Import Post_MergeMCPTool - included in same package
// Import Post_Libreoffice_ConvertMCPTool - included in same package
// Import Post_Chrome_UrlMCPTool - included in same package
// Import Get_Chrome_UrlMCPTool - included in same package
// Import Post_Chrome_HtmlMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Post_Wkhtmltopdf_HtmlMCPTool.createPost_Wkhtmltopdf_HtmlTool(config),
            Get_Wkhtmltopdf_UrlMCPTool.createGet_Wkhtmltopdf_UrlTool(config),
            Post_Wkhtmltopdf_UrlMCPTool.createPost_Wkhtmltopdf_UrlTool(config),
            Post_MergeMCPTool.createPost_MergeTool(config),
            Post_Libreoffice_ConvertMCPTool.createPost_Libreoffice_ConvertTool(config),
            Post_Chrome_UrlMCPTool.createPost_Chrome_UrlTool(config),
            Get_Chrome_UrlMCPTool.createGet_Chrome_UrlTool(config),
            Post_Chrome_HtmlMCPTool.createPost_Chrome_HtmlTool(config)
            );
