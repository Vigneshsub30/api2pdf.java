...
class Post_Wkhtmltopdf_UrlMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Wkhtmltopdf_UrlHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("options")) {
            queryParams.add("options=" + args.get("options"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_wkhtmltopdf_url" + queryString;
    ...
    public static MCPServer.Tool createPost_Wkhtmltopdf_UrlTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_wkhtmltopdf_url",
            "Convert URL to PDF",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Wkhtmltopdf_UrlHandler(config));
    }
